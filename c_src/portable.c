...
int
create_tmpfile_from_image(int *fdp, char **namep, uint8_t *image, size_t image_size) {
    int fd;
    char *name;
...
int
get_vrouter_btf_image(unsigned char **imagep, unsigned int *image_sizep) {
...
int
get_kprobe_mod_image(unsigned char **imagep, unsigned int *image_sizep) {
...
int
do_link(char **namep, unsigned char *image, unsigned int image_size) {
    int error = -1, fd;
